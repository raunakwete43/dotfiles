...
x = int(input('Enter 1st operand: '))
# taking x and y decimal numbers as input for x * y
y = int(input('Enter 2nd operand: '))
a = bin(x).replace("0b", "")
b = bin(y).replace("0b", "")
negative_a = 0
negative_b = 0
...
print("Count" + " "*count1 + "AC" + " "*count1 + "Q" +
      " "*count1 + "Q1" + " "*count1 + "Operation")
print(str(count) + " "*count1 + AC + " "*count1 +
      Q + " "*count1 + Q1 + " "*count1 + "initial")
print("\n")
